...
class VerifyBenchmarking(unittest.TestCase):
    ...
    def test_job_is_merged_with_good_arguments(self):
        ...
        self.assertEqual(job["mainPythonFileUri"], "gs://polidea-dataproc-utils/bigbench/triggerBigbenchBenchmark.py")
                                  ...
                                  {'managedCluster':
                                       {'config':
                                            {'initializationActions':
                                                 {'executableFile':
                                                      'gs://polidea-dataproc-utils/hibench.sh'}}}}}})
